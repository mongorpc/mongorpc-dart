...
class CreateCollectionRequest extends $pb.GeneratedMessage {
  ...
  factory CreateCollectionRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateCollectionRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  CreateCollectionRequest clone() =>
      CreateCollectionRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CreateCollectionRequest copyWith(
      ...
      super.copyWith((message) => updates(message as CreateCollectionRequest))
          as CreateCollectionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateCollectionRequest create() => CreateCollectionRequest._();
  CreateCollectionRequest createEmptyInstance() => create();
  static $pb.PbList<CreateCollectionRequest> createRepeated() =>
      $pb.PbList<CreateCollectionRequest>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set options(CreateCollectionOptions v) {
    setField(3, v);
  }
...
class CreateCollectionOptions extends $pb.GeneratedMessage {
  ...
  factory CreateCollectionOptions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CreateCollectionOptions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  CreateCollectionOptions clone() =>
      CreateCollectionOptions()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CreateCollectionOptions copyWith(
      ...
      super.copyWith((message) => updates(message as CreateCollectionOptions))
          as CreateCollectionOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateCollectionOptions create() => CreateCollectionOptions._();
  CreateCollectionOptions createEmptyInstance() => create();
  static $pb.PbList<CreateCollectionOptions> createRepeated() =>
      $pb.PbList<CreateCollectionOptions>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set validationLevel($core.String v) {
    $_setString(3, v);
  }
  ...
  @$pb.TagNumber(5)
  set validationAction($core.String v) {
    $_setString(4, v);
  }
...
class DropCollectionRequest extends $pb.GeneratedMessage {
  ...
  factory DropCollectionRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DropCollectionRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  DropCollectionRequest clone() =>
      DropCollectionRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DropCollectionRequest copyWith(
      ...
      super.copyWith((message) => updates(message as DropCollectionRequest))
          as DropCollectionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DropCollectionRequest create() => DropCollectionRequest._();
  DropCollectionRequest createEmptyInstance() => create();
  static $pb.PbList<DropCollectionRequest> createRepeated() =>
      $pb.PbList<DropCollectionRequest>();
  @$core.pragma('dart2js:noInline')
...
class ListCollectionsRequest extends $pb.GeneratedMessage {
  ...
  factory ListCollectionsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory ListCollectionsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  ListCollectionsRequest clone() =>
      ListCollectionsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  ListCollectionsRequest copyWith(
      ...
      super.copyWith((message) => updates(message as ListCollectionsRequest))
          as ListCollectionsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListCollectionsRequest create() => ListCollectionsRequest._();
  ListCollectionsRequest createEmptyInstance() => create();
  static $pb.PbList<ListCollectionsRequest> createRepeated() =>
      $pb.PbList<ListCollectionsRequest>();
  @$core.pragma('dart2js:noInline')
...
class IndexKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<IndexDirection>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'direction',
        $pb.PbFieldType.OE,
        defaultOrMaker: IndexDirection.ASCENDING,
        valueOf: IndexDirection.valueOf,
  ...
  factory IndexKey.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory IndexKey.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  IndexKey copyWith(void Function(IndexKey) updates) =>
      super.copyWith((message) => updates(message as IndexKey))
          as IndexKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
