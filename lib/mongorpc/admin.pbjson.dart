...
final $typed_data.Uint8List dropDatabaseRequestDescriptor = $convert.base64Decode('ChNEcm9wRGF0YWJhc2VSZXF1ZXN0EhoKCGRhdGFiYXNlGAEgASgJUghkYXRhYmFzZQ==');
...
final $typed_data.Uint8List createCollectionRequestDescriptor = $convert.base64Decode('ChdDcmVhdGVDb2xsZWN0aW9uUmVxdWVzdBIaCghkYXRhYmFzZRgBIAEoCVIIZGF0YWJhc2USHgoKY29sbGVjdGlvbhgCIAEoCVIKY29sbGVjdGlvbhI7CgdvcHRpb25zGAMgASgLMiEubW9uZ29ycGMuQ3JlYXRlQ29sbGVjdGlvbk9wdGlvbnNSB29wdGlvbnM=');
...
const CreateCollectionOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'validator', '3': 3, '4': 1, '5': 11, '6': '.mongorpc.Value', '10': 'validator'},
    const {'1': 'validationLevel', '3': 4, '4': 1, '5': 9, '10': 'validationLevel'},
    const {'1': 'validationAction', '3': 5, '4': 1, '5': 9, '10': 'validationAction'},
    const {'1': 'storageEngine', '3': 6, '4': 1, '5': 11, '6': '.mongorpc.Value', '10': 'storageEngine'},
  ],
};

/// Descriptor for `CreateCollectionOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createCollectionOptionsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List dropCollectionRequestDescriptor = $convert.base64Decode('ChVEcm9wQ29sbGVjdGlvblJlcXVlc3QSGgoIZGF0YWJhc2UYASABKAlSCGRhdGFiYXNlEh4KCmNvbGxlY3Rpb24YAiABKAlSCmNvbGxlY3Rpb24=');
...
final $typed_data.Uint8List dropIndexRequestDescriptor = $convert.base64Decode('ChBEcm9wSW5kZXhSZXF1ZXN0EhoKCGRhdGFiYXNlGAEgASgJUghkYXRhYmFzZRIeCgpjb2xsZWN0aW9uGAIgASgJUgpjb2xsZWN0aW9uEhQKBWluZGV4GAMgASgJUgVpbmRleA==');
