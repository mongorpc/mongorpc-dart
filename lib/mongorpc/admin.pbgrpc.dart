...
class MongoRPCAdminClient extends $grpc.Client {
  ...
  MongoRPCAdminClient($grpc.ClientChannel channel,
      {$grpc.CallOptions? options,
      $core.Iterable<$grpc.ClientInterceptor>? interceptors})
      : super(channel, options: options, interceptors: interceptors);

  $grpc.ResponseFuture<$0.Value> listDatabases($0.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listDatabases, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> dropDatabase($1.DropDatabaseRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.Value> listIndexes($1.ListIndexesRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.Empty> dropIndex($1.DropIndexRequest request,
      {$grpc.CallOptions? options}) {
